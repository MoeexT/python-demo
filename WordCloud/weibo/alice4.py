...
# d = path.dirname('.')
d = path.dirname('D:\\Sarmon\\Documents\\Codes\\Python\\WordCloud\\weibo')

stopwords = {}
isCN = 1 #默认启用中文分词
back_coloring_path = "img/logo1024.jpg" # 设置背景图片路径
text_path = 'txt/hotWords.txt' #设置要分析的文本路径
